                    ...
                    <div class="row">
                        <div class="col-md-6 leaf">
                            <div class="text-holder">
                                ...
                                <p>
                                This half-moon shaped restaurant on the slopes of a small 
                                hill overlooking the rice field, lake and tea plantations is 
                                made of wooden frame with thick thatch roof. It features a Show 
                                Kitchen where cooking is done in front of the guests and serves 
                                limited varieties of Continental and Bangladeshi cuisines. The 
                                buffet breakfast is also served here.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 leaf">
                            <div class="text-holder">
                                ...
                                <p>
                                The Bar of the resort is a floating platform jutting out 
                                onto the valley housing the main pool. It serves different 
                                kinds of cocktails, mocktails, Beers, Red & White Wines. 
                                Foreign guests are allowed to bring in their own alcoholic 
                                drinks for consumption in their rooms.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 leaf">
                            <div class="text-holder">
                                ...
                                <p>
                                This unique sunken pool cafe, the first of its kind in Bangladesh, 
                                serves snacks, soft drinks and juices to the pool guests.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 leaf">
                            <div class="text-holder">
                                ...
                                <p>
                                A newly made relaxing Lounge, overlooking the 
                                forest for guests to while away their evening time 
                                over snacks and hot & cold beverages.
                                </p>
                            </div>
                        </div>
                    </div>
